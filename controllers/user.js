...
exports.getAllUser = exports.verifyDeactivateAccountOTP = exports.changePassword = exports.updateUser = exports.isActiveUser = exports.getUser = exports.deactivateUser = void 0;
...
const getAllUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let allUsers = [];
    try {
        const users = yield user_1.default.find({}, { name: 1, _id: 1 });
        if (!users) {
            const err = new error_1.default("No users found");
            err.statusCode = 404;
            throw err;
        }
